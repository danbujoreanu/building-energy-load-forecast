...
| **Oslo Generalization** | ✅ Done | Run the Champion(s) on the Oslo dataset (100% Schools) to prove climate/building transferability based on Drammen School metrics. *Completed with Stacking Ensemble (MAE: 7.28, R²: 0.963) and LightGBM (MAE: 7.41, R²: 0.963).* | High |

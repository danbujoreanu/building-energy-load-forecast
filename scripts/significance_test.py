...
_DM_COMPARISONS = [
    ("LightGBM_SetupA", "PatchTST_SetupC", "LightGBM (Setup A) vs PatchTST (Setup C)"),
    ("LightGBM_SetupA", "CNN-LSTM_SetupC", "LightGBM (Setup A) vs CNN-LSTM (Setup C)"),
    ("LightGBM_SetupA", "Ridge_SetupA",    "LightGBM (Setup A) vs Ridge (Setup A)"),
]
